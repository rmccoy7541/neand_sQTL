...
sqtl <- read.table("~/work/aseyedi2/sQTLv8/data/GTEx_Analysis_v8_sQTL/Ovary.v8.sqtl_signifpairs.txt.gz", stringsAsFactors=FALSE, header=TRUE)
...
write.table(combined, file="combined_SY.txt", sep="\t", quote=FALSE)
...
write.table(combined2, file="combined2_SY.txt", sep="\t", quote=FALSE)
