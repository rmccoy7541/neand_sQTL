...
Okay, just talked to Rajiv and he's cool with not using GNU-Parallel. Who cares, right? He certainly doesn't. It doesn't matter. I have been working since August and have not produced a single piece of analysis (lol). I think I've finally accepted myself for who I am: a dumb guy in STEM. They need us. We make sure they don't drive themselves to self-harm. We remind them that there's a different way to live ("They" in this case being people with genuine career aptitude for the technical sciences and not people who just stumbled into whatever field ass-first because they wanted a job and thought learning about drugs was cool).
